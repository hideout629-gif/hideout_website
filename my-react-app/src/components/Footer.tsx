        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8 items-center w-full">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="flex items-center gap-2.5 pt-1">
              <a href="#" aria-label="Instagram" className="w-8.5 h-8.5 rounded-full bg-white/5 hover:bg-[#E5B849] hover:text-[#08170E] text-gray-300 border border-white/15 flex items-center justify-center transition-all">
              ...
              <a href="#" aria-label="Facebook" className="w-8.5 h-8.5 rounded-full bg-white/5 hover:bg-[#E5B849] hover:text-[#08170E] text-gray-300 border border-white/15 flex items-center justify-center transition-all">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                  <path d="M9 8H6v4h3v12h5V12h3.642L18 8h-4V6.333C14 5.374 14.5 5 15.714 5H18V0h-3.808C10.598 0 9 1.582 9 4.615V8z"/>
                </svg>
              </a>
              <a href="#" aria-label="YouTube" className="w-8.5 h-8.5 rounded-full bg-white/5 hover:bg-[#E5B849] hover:text-[#08170E] text-gray-300 border border-white/15 flex items-center justify-center transition-all">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
              <a href="#" aria-label="Twitter" className="w-8.5 h-8.5 rounded-full bg-white/5 hover:bg-[#E5B849] hover:text-[#08170E] text-gray-300 border border-white/15 flex items-center justify-center transition-all">
                <svg className="w-3 h-3 fill-current" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="#" aria-label="LinkedIn" className="w-8.5 h-8.5 rounded-full bg-white/5 hover:bg-[#E5B849] hover:text-[#08170E] text-gray-300 border border-white/15 flex items-center justify-center transition-all">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-2 lg:border-r lg:border-white/10 lg:pr-4">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm">
              ...
              <li><a href="#gallery" className="hover:text-[#E5B849] transition-colors flex items-center justify-between text-gray-300 hover:translate-x-1 duration-200"><span>Photo Gallery</span><ChevronRight className="w-3.5 h-3.5 text-gray-500" /></a></li>
              <li><a href="#reviews" className="hover:text-[#E5B849] transition-colors flex items-center justify-between text-gray-300 hover:translate-x-1 duration-200"><span>Guest Testimonials</span><ChevronRight className="w-3.5 h-3.5 text-gray-500" /></a></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2 lg:border-r lg:border-white/10 lg:pr-4">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm">
              ...
              <li><a href="#cottages" className="hover:text-[#E5B849] transition-colors flex items-center justify-between text-gray-300 hover:translate-x-1 duration-200"><span>Misty Pines Honeymoon Suite</span><ChevronRight className="w-3.5 h-3.5 text-gray-500" /></a></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2 lg:border-r lg:border-white/10 lg:pr-4 space-y-2.5">
            ...
            <ul className="space-y-3 text-xs sm:text-sm">
              ...
              <li className="flex items-start gap-2 text-gray-300">
                <div className="w-6.5 h-6.5 rounded-full bg-emerald-950 border border-emerald-500/30 text-[#E5B849] flex items-center justify-center shrink-0">
          ...
          <div className="lg:col-span-3 w-full flex items-center justify-center">
            ...
            >
              ...
              <div className="absolute bottom-0 inset-x-0 p-3 bg-black/75 backdrop-blur-md border-t border-white/10 flex items-center justify-between">
                <div>
                  <div className="text-xs font-bold text-white font-serif">Find Us on Map</div>
                  <div className="text-[10px] text-gray-300 font-medium">Get directions to Hideout</div>
                </div>
                <div className="w-7.5 h-7.5 rounded-full bg-[#E5B849] text-[#08170E] flex items-center justify-center shadow-md group-hover:translate-x-0.5 transition-transform shrink-0">
