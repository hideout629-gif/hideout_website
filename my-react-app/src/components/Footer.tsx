...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#08170E] text-gray-300 relative w-full overflow-hidden">
      ...
      <div className="hidden lg:block absolute top-12 right-16 text-right pointer-events-none opacity-40 z-10">
      ...
      <div className="absolute -bottom-10 -left-10 w-80 h-80 opacity-25 pointer-events-none z-10">
      ...
      <div className="absolute -bottom-10 -right-10 w-80 h-80 opacity-25 pointer-events-none z-10">
        <svg viewBox="0 0 200 200" fill="#2E6B43" className="w-full h-full">
      ...
      {/* Main Container */}
      <div className="w-full max-w-[1700px] mx-auto px-8 sm:px-12 md:px-16 lg:px-20 py-8 md:py-12 relative z-20">
        
        {/* 5 Grid Columns with Vertical Dividers */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8 items-start">
          
          {/* Column 1: Brand Info (3.5 cols) */}
          <div className="lg:col-span-3 lg:pr-4 space-y-6">
            ...
            <p className="text-sm text-gray-300 leading-relaxed max-w-sm">
              Handcrafted luxury wooden mountain cottages in the heart of Ooty's misty tea valleys. Experience peace, warmth, and nature's finest views.
            </p>

            {/* Social Icons Row */}
            <div className="flex items-center gap-3 pt-2">
              <a href="#" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#E5B849] hover:text-[#08170E] text-gray-300 border border-white/15 flex items-center justify-center transition-all">
              ...
              <a href="#" aria-label="Facebook" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#E5B849] hover:text-[#08170E] text-gray-300 border border-white/15 flex items-center justify-center transition-all">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M9 8H6v4h3v12h5V12h3.642L18 8h-4V6.333C14 5.374 14.5 5 15.714 5H18V0h-3.808C10.598 0 9 1.582 9 4.615V8z"/>
                </svg>
              </a>
              <a href="#" aria-label="YouTube" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#E5B849] hover:text-[#08170E] text-gray-300 border border-white/15 flex items-center justify-center transition-all">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
              <a href="#" aria-label="Twitter" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#E5B849] hover:text-[#08170E] text-gray-300 border border-white/15 flex items-center justify-center transition-all">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#E5B849] hover:text-[#08170E] text-gray-300 border border-white/15 flex items-center justify-center transition-all">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            <div className="pt-2 flex items-center gap-2.5">
              ...
              <span className="font-serif italic text-emerald-200/90 text-base font-normal">
          ...
          <div className="lg:col-span-2 lg:border-r lg:border-white/10 lg:pr-6">
            <h4 className="text-lg font-bold text-white font-serif mb-5 pb-2 border-b border-white/10">
              Quick Links
            </h4>
          ...
          <div className="lg:col-span-2 lg:border-r lg:border-white/10 lg:pr-6 space-y-4">
            <h4 className="text-lg font-bold text-white font-serif mb-5 pb-2 border-b border-white/10">
              Contact Info
            </h4>
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3 text-gray-300">
                <div className="w-8 h-8 rounded-full bg-emerald-950 border border-emerald-500/30 text-[#E5B849] flex items-center justify-center shrink-0 mt-0.5">
                  <MapPin className="w-4 h-4 text-[#E5B849]" />
                </div>
                <span className="leading-snug">Misty Valley Road, Fernhill, Ooty, Tamil Nadu 643004</span>
              </li>
              <li className="flex items-start gap-3 text-gray-300">
                <div className="w-8 h-8 rounded-full bg-emerald-950 border border-emerald-500/30 text-[#E5B849] flex items-center justify-center shrink-0">
              ...
              <li className="flex items-center gap-3 text-gray-300">
                ...
                <span>stay@ootycottage.com</span>
              </li>
              <li className="flex items-start gap-3 text-gray-300">
                <div className="w-8 h-8 rounded-full bg-emerald-950 border border-emerald-500/30 text-[#E5B849] flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div className="leading-snug">
                  ...
                  <div className="text-xs text-gray-400 font-semibold">(24/7 Front Desk)</div>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 w-full">
            <a 
              ...
              className="block rounded-[24px] overflow-hidden border-2 border-white/20 shadow-2xl relative h-72 lg:h-[300px] group cursor-pointer w-full"
            >
              <img 
                src="https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&q=80&w=800" 
                alt="Ooty Cottage Map Location" 
              ...
              <div className="absolute inset-0 flex items-center justify-center pb-8">
                <div className="relative">
                  <div className="w-12 h-12 rounded-full bg-black/60 backdrop-blur-md text-emerald-400 flex items-center justify-center shadow-lg border border-white/30 transform group-hover:scale-110 transition-transform">
                    <MapPin className="w-6 h-6 text-emerald-400" />
                  </div>
                </div>
              </div>

              <div className="absolute bottom-0 inset-x-0 p-4 bg-black/75 backdrop-blur-md border-t border-white/10 flex items-center justify-between">
                <div>
                  <div className="text-sm font-bold text-white font-serif">Find Us on Map</div>
                  <div className="text-xs text-gray-300 font-medium">Get directions to Ooty Cottage</div>
                </div>
                <div className="w-9 h-9 rounded-full bg-[#E5B849] text-[#08170E] flex items-center justify-center shadow-md group-hover:translate-x-0.5 transition-transform shrink-0">
        ...
        <div className="mt-8 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400 font-medium w-full">
          
          {/* Left Copyright */}
          <div>
            © {new Date().getFullYear()} Ooty Cottage Resort. All Rights Reserved.
          </div>
