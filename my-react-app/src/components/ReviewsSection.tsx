...
export const ReviewsSection: React.FC = () => {
  const { containerRef: scrollContainerRef, isMouseDown, dragProps } = useHorizontalScroll<HTMLDivElement>();
        ...
        >
          {reviewsData.map((rev, idx) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="snap-start shrink-0 w-[280px] sm:w-[310px] lg:w-[330px] bg-white rounded-[22px] overflow-hidden border border-gray-200/80 shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col justify-between group select-none"
            >
